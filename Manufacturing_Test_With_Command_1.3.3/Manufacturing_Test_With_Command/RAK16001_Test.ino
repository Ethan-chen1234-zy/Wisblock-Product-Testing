...
#include <Wire.h>
#include "ADS7830.h"    //Click here to get the library: http://librarymanager/All#RAKwireless_ADS7830_library
ADS7830 ads;

void RAK16001_test(unsigned long timeout)
{
  ...
  else
  {
    ...
    Serial.printf("-----------RAK16001 Test Failed!-----------\n");
  }
  delay(500);
}
#endif
